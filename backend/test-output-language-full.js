...
/**
 * Full test script for Output Language Selection Feature
 * Tests with complete transcripts to verify all headers and formatting
 */

// Full test data as provided by user
...
// Test scenarios with full expected headers
...
async function runAllTests() {
  console.log('🚀 Starting FULL Output Language Selection Tests');
  console.log('=' .repeat(80));
