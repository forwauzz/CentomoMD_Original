// Test for spacing preservation in name restoration
console.log('=== SPACING PRESERVATION TEST ===\n');
...
console.log('\n=== TESTING SPACING-PRESERVING RESTORATION ===');

// Simulate the restoreTruncatedNames logic with improved spacing
function restoreTruncatedNamesSpacingFix(originalContent, formattedContent, language = 'fr') {
...
const restorationResult = restoreTruncatedNamesSpacingFix(originalContent, formattedContent);
