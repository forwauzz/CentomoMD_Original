...
function convertSpokenCommands(text: string): string {
  ...
  const replacements: Array<[RegExp, string]> = [
    ...
    // French parenthesis commands (imperative forms)
    [/\bouvrez\s*la\s*parenthèse\b/gi, "("],
    [/\bfermez\s*la\s*parenthèse\b/gi, ")"],
    [/\bouvrez\s*les\s*parenthèses\b/gi, "("],
    [/\bfermez\s*les\s*parenthèses\b/gi, ")"],
    
    // French quote commands (imperative forms)
    [/\bouvrez\s*les\s*guillemets\b/gi, "«"],
    [/\bfermez\s*les\s*guillemets\b/gi, "»"],
    [/\bguillemets\b/gi, "«"],
    
    // French ellipsis commands
    [/\btrois\s*petits\s*points\b/gi, "…"],
    [/\btrois\s*points\b/gi, "…"],
