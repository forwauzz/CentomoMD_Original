...
const hardcodedEnv: Environment = {
  ...
  // CORS Configuration
  CORS_ALLOWED_ORIGINS: 'http://localhost:5173,https://centomo-md-original-kskp.vercel.app,https://*.vercel.app,https://innovations-shares-correlation-surely.trycloudflare.com,https://sierra-lips-gets-size.trycloudflare.com,https://pumps-steal-potatoes-forgot.trycloudflare.com,https://reliable-seal-log-without.trycloudflare.com',
