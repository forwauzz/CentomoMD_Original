...
export const getFeatureFlags = (): FeatureFlags => {
  ...
  const envFlags = {
    ...
    ambientDebugMode: import.meta.env.VITE_FEATURE_AMBIENT_DEBUG_MODE === 'true',
  };
  ...
  const devFlags = {
    ...
    ambientDebugMode: true, // Enable for debugging speaker diarization
  };
  ...
  return {
    ...
    ambientDebugMode: envFlags.ambientDebugMode || devFlags.ambientDebugMode,
  };
};
