        ...
        <div className="flex-1 flex justify-end">
          {!isRecording ? (
            <Button
              ...
              variant="medical"
              className="flex items-center justify-center space-x-2 h-12 px-6 rounded-full bg-[#007a2e] hover:bg-[#006a26] text-white text-sm font-medium shadow-lg hover:shadow-xl transition-all"
            >
