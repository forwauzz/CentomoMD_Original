...
export const TEMPLATE_CONFIGS: TemplateConfig[] = [
  ...
  },
  {
    ...
    name: 'Neuro Expertise Formatter (Enhanced)',
    nameFr: 'Formateur Expertise Neurologique (Amélioré)',
    description: 'Enhanced AI-powered neurological expertise formatting with comprehensive prompt system. 6-step flowchart implementation for neurological evaluations and medical expertise.',
    descriptionFr: 'Formatage IA expertise neurologique amélioré avec système de prompts complet. Implémentation flowchart 6 étapes pour évaluations neurologiques et expertise médicale.',
    type: 'ai-formatter',
    compatibleSections: ['section_7', 'section_8', 'section_11', 'section_custom'],
    compatibleModes: ['mode1', 'mode2', 'mode3'],
    language: 'both',
    complexity: 'high',
    tags: ['neuro', 'neurology', 'ai-formatter', 'medical', 'enhanced', 'flowchart', 'specialty'],
    isActive: true,
    isDefault: false,
    features: {
      verbatimSupport: false,
    ...
    prompt: 'Enhanced AI-powered neurological expertise formatting with comprehensive prompt system. 6-step flowchart: 1) Load language files, 2-4) Construct system prompt, 5) OpenAI API call, 6) Post-processing validation.',
    promptFr: 'Formatage IA expertise neurologique amélioré avec système de prompts complet. Flowchart 6 étapes: 1) Charger fichiers langue, 2-4) Construire prompt système, 5) Appel API OpenAI, 6) Validation post-traitement.',
    config: {
      mode: 'mode2',
      language: 'fr',
      enforceWorkerFirst: true,
      chronologicalOrder: true,
      medicalTerminology: true,
      templateCombo: 'neuro-expertise-formatter'
    },
    usage: {
      count: 0,
      successRate: 95,
